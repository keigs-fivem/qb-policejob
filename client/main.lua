...
AddEventHandler('police:client:UpdateBlips', function(players)
    ...
    if PlayerJob ~= nil and (PlayerJob.name == 'police' or PlayerJob.name == 'ambulance' or PlayerJob.name == 'doctor') and
        onDuty then
    ...
    TriggerServerEvent('qb-policealerts:server:AddPoliceAlert', {
        ...
        details = {
            [1] = {
                ...
                detail = MyId .. ' | ' .. QBCore.Functions.GetPlayerData().charinfo.firstname .. ' ' ..
